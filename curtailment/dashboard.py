...
# Inject custom code to override default Streamlit widget styling and apply dark theme branding
tf.markdown(f"""
    <style>
...
# 3a. APPLICATION HEADER SECTION & LIVE STATUS BADGES
...
# 3b. ON-DEMAND LIVE POLL CONTROL
...
with trend_col:
    with tf.container(border=True):
        ...
        # Layout styling for dark UI background
